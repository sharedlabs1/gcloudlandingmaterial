# Lab 12 Solution: Disaster Recovery & Backup
terraform {
...
locals {
  common_labels = {
    ...
    component   = "disaster-recovery-&-backup"
  }
}

# Lab-specific resources for Disaster Recovery & Backup
...
resource "google_storage_bucket" "lab_12_bucket" {
  name     = "${var.project_id}-lab-12-resources"
  location = var.region
