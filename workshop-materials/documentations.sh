...
echo "Creating GCP Landing Zone Workshop Documentation & Presentations..."
...
echo "Creating main workshop presentation..."
...
echo "✅ Workshop documentation and presentations created successfully!"
echo "📁 Location: workshop-materials/docs/"
echo "🎯 Start with: docs/presentations/workshop-overview.md"
echo "📚 Reference: docs/reference/complete-workshop-guide.md"
echo "🔧 Generate presentations: docs/generate-presentations.sh"